...
const nextApp = {
  ...
  env: {
    ...
    // v5-A1 (2026-05-08): 'auto' 是死链路（8s 超时 0 bytes），从 fallback 链摘掉
    MODEL_FALLBACK_CHAIN: 'gpt-5.2',
    REPORT_MODEL_FALLBACK_CHAIN: 'gpt-5.2',
    REPORT_NARRATIVE_MODEL_FALLBACK_CHAIN: 'gpt-5.2',
    CONTENT_GENERATION_MODEL_FALLBACK_CHAIN: 'gpt-5.2',
    OPEN_AGENT_RUNTIME_ENABLED: openAgentRuntimeEnabled,
    // v5-A2 (2026-05-08): 熔断阈值收紧 — 故障链路更快摘掉、健康链路更快恢复
    LLM_HEALTH_WINDOW_MINUTES: '15',
    LLM_CIRCUIT_OPEN_MIN_ATTEMPTS: '3',
    LLM_CIRCUIT_OPEN_FAILURE_RATE: '0.6',
    LLM_CIRCUIT_DEGRADE_FAILURE_RATE: '0.40',
    LLM_CIRCUIT_RECOVER_FAILURE_RATE: '0.25',
    LLM_CIRCUIT_OPEN_CONSECUTIVE_FAILURES: '3',
