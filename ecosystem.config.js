...
const backgroundWorkers = enableBackgroundWorkers ? [
  ...
  },
  {
    ...
    env: {
      ...
      DAILY_WINDOW_EMAIL_RETRY_DELAY_MS: '300000',
    },
    error_file: '/root/.pm2/logs/life-kline-daily-window-email-error.log',
    out_file: '/root/.pm2/logs/life-kline-daily-window-email-out.log',
    log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
    merge_logs: true,
    autorestart: true,
    max_restarts: 20,
  ...
  {
    name: 'life-kline-astro-daily-email',
    script: 'scripts/astro-daily-email-daemon.js',
    cwd: '/home/life-kline-next',
    instances: 1,
    exec_mode: 'fork',
    env: {
      NODE_ENV: 'production',
      ASTRO_DAILY_EMAIL_ENABLED: process.env.ASTRO_DAILY_EMAIL_ENABLED || '1',
      TIMING_EMAIL_CRON_TOKEN: cronEnv.TIMING_EMAIL_CRON_TOKEN,
      ASTRO_DAILY_EMAIL_CRON_TOKEN: cronEnv.TIMING_EMAIL_CRON_TOKEN,
      ASTRO_DAILY_EMAIL_RUN_URL: `http://${INTERNAL_API_HOST}/api/admin/astro-daily/email/cron?limit=50`,
      ASTRO_DAILY_EMAIL_INTERVAL_MS: '86400000',
      ASTRO_DAILY_EMAIL_REQUEST_TIMEOUT_MS: '90000',
      ASTRO_DAILY_EMAIL_STARTUP_DELAY_MS: '70000',
    },
    error_file: '/root/.pm2/logs/life-kline-astro-daily-email-error.log',
    out_file: '/root/.pm2/logs/life-kline-astro-daily-email-out.log',
    log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
    merge_logs: true,
    autorestart: true,
    max_restarts: 20,
  ...
  {
    name: 'life-kline-astro-weekly-email',
    script: 'scripts/astro-weekly-email-daemon.js',
    cwd: '/home/life-kline-next',
    instances: 1,
    exec_mode: 'fork',
    env: {
      NODE_ENV: 'production',
      ASTRO_WEEKLY_EMAIL_ENABLED: process.env.ASTRO_WEEKLY_EMAIL_ENABLED || '1',
      TIMING_EMAIL_CRON_TOKEN: cronEnv.TIMING_EMAIL_CRON_TOKEN,
      ASTRO_WEEKLY_EMAIL_CRON_TOKEN: cronEnv.TIMING_EMAIL_CRON_TOKEN,
      ASTRO_WEEKLY_EMAIL_RUN_URL: `http://${INTERNAL_API_HOST}/api/admin/astro-weekly/email/cron?limit=50`,
      ASTRO_WEEKLY_EMAIL_INTERVAL_MS: '604800000',
      ASTRO_WEEKLY_EMAIL_REQUEST_TIMEOUT_MS: '120000',
      ASTRO_WEEKLY_EMAIL_STARTUP_DELAY_MS: '90000',
    },
    error_file: '/root/.pm2/logs/life-kline-astro-weekly-email-error.log',
    out_file: '/root/.pm2/logs/life-kline-astro-weekly-email-out.log',
    log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
    merge_logs: true,
    autorestart: true,
    max_restarts: 20,
