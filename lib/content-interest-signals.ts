...
export const STRATEGIC_CLUSTERS: StrategicCluster[] = [
  ...
  // ── Content OS global expansion (LDPlayer-parity multi-locale / multi-market) ──
  {
    key: 'day-master-playbook',
    title: '日主发挥方式图鉴',
    angle: '把十个日主写成可检索实体内容，降低命理门槛并承接长尾搜索',
    keywords: ['日主', '甲木', '乙木', '丙火', '丁火', '戊土', '己土', '庚金', '辛金', '壬水', '癸水', 'day master'],
    primaryType: 'knowledge',
    baseDemand: 11,
    topic: '十个日主各自的发挥方式、摩擦点与适配场景',
    audience: '想理解自己日主风格的新用户',
  },
  {
    key: 'life-decision-faq',
    title: '人生决策高频问题',
    angle: '对标实体攻略页：换工作、婚恋、迁移、创业等高意图问题页',
    keywords: ['换工作', '结婚', '迁移', '创业', '改名', '本命年', '该不该', '什么时候'],
    primaryType: 'knowledge',
    baseDemand: 12,
    topic: '高频人生决策问题如何用结构时位环境拆解',
    audience: '带着明确问题来搜的用户',
  },
  {
    key: 'global-english-decision',
    title: 'Global English decision frameworks',
    angle: 'English-native decision content for diaspora and international users',
    keywords: ['bazi', 'four pillars', 'life rhythm', 'career timing', 'World Yi', 'destiny structure'],
    primaryType: 'knowledge',
    baseDemand: 10,
    topic: 'How to use Bazi structure as a decision framework in English',
    audience: 'English-speaking and overseas Chinese professionals',
  },
  {
    key: 'traditional-chinese-markets',
    title: '繁體市場內容（台港澳）',
    angle: '繁體原生表達：擇日、改運節奏、家庭與居住場景',
    keywords: ['八字', '擇日', '流年', '改運', '合婚', '風水', '台灣', '香港'],
    primaryType: 'knowledge',
    baseDemand: 9,
    topic: '繁體用戶如何用結構判斷代替吉凶標籤',
    audience: '台灣、香港與繁體閱讀用戶',
  },
  {
    key: 'seasonal-timing-seo',
    title: '时令节奏 SEO',
    angle: '月度/年度时令内容保持收录新鲜度，方法仍是框架而非恐吓运势',
    keywords: ['流年', '月运', '本月', '今年', '节奏窗口', '太岁'],
    primaryType: 'knowledge',
    baseDemand: 9,
    topic: '时令内容如何写成可验证的决策窗口观察',
    audience: '搜索当月/当年运势的用户',
  },
  {
    key: 'tool-seo-hubs',
    title: '工具实体 SEO 枢纽',
    angle: '每个核心工具一页深度教程+对比，对标竞品下载/功能实体页',
    keywords: ['排盘', '合婚', '起名', '风水', '黄历', '星座', '人生k线', '教程'],
    primaryType: 'knowledge',
    baseDemand: 10,
    topic: '核心工具如何写成可转化的 SEO 教程实体',
    audience: '比较工具、寻找教程的用户',
  },
];
