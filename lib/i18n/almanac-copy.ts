...
export const YI_JI_EN: Record<string, string> = {
  ...
  作门: 'Make door',
  筑堤: 'Build embankment',
  补垣塞穴: 'Mend walls / fill holes',
  平治道途: 'Level roads',
  修饰垣墙: 'Repair walls',
  开厕修厕: 'Build toilet',
  安香火: 'Install incense fire',
  出火入宅: 'Hearth move / move-in',
  移徙入宅: 'Relocation / move-in',
  安床会亲: 'Install bed / meet kin',
  经络裁衣: 'Meridians / tailoring',
  开市交易: 'Open shop / trade',
  立券交易: 'Sign contracts',
  纳财开仓: 'Receive wealth / open store',
  修造动土: 'Build / break ground',
  竖柱上梁: 'Raise pillars / ridge',
  安机械: 'Install machinery',
  造桥: 'Build bridge',
  开光安香: 'Consecrate / incense',
  破屋坏垣: 'Demolish house / walls',
  乘船渡水: 'Boat travel',
  针灸: 'Acupuncture',
  行丧: 'Funeral rites',
  安门作灶: 'Door / stove install',
  开渠穿井: 'Canal / well',
  造仓盖屋: 'Storehouse / roofing',
  栽种牧养: 'Plant / herd',
  捕捉取渔: 'Hunt / fish',
  安葬启攒: 'Burial rites',
  修造安葬: 'Build / bury',
  订婚纳采: 'Engagement rites',
  冠笄出行: 'Coming-of-age / travel',
  解除扫舍: 'Clear / sweep',
  沐浴剃头: 'Bath / haircut',
  // Extra labels seen in lunar-javascript day yi/ji dumps
  乘船: 'Boat travel',
  习艺: 'Learn a craft',
  出货财: 'Ship goods / wealth out',
  入学: 'Start school',
  割蜜: 'Harvest honey',
  合脊: 'Join roof ridge',
  归宁: 'Bride returns home',
  归岫: 'Return to mountain (retire)',
  拆卸: 'Dismantle',
  挂匾: 'Hang plaque',
  探病: 'Visit the sick',
  放水: 'Release water',
  ...
  架马: 'Scaffold / frame',
  无: 'None',
  普渡: 'Universal salvation rite',
  断蚁: 'Stop ants / pest control',
  纳婿: 'Take a son-in-law',
  置产: 'Acquire property',
  立碑: 'Erect stele',
  造船: 'Build boat',
  问名: 'Ask name (betrothal)',
  雇佣: 'Hire workers',
  雕刻: 'Carve / engrave',
  纳采问名: 'Betrothal inquiry',
};
