...
export function funnelCopy(locale: SiteLocale) {
  return {
    ...
    formEyebrow: pick(locale, {
      'zh-CN': 'LIFE K-LINE · 命盘推演',
      'zh-Hant': 'LIFE K-LINE · 命盤推演',
      en: 'LIFE K-LINE · Chart',
    }),
    formTitleInline: pick(locale, {
      'zh-CN': '看清原局底色、岁运起伏与当下决断',
      'zh-Hant': '看清原局底色、歲運起伏與當下決斷',
      en: 'See natal tone, decade rhythm, and the decision in front of you',
    }),
    hourByDayPillar: pick(locale, {
      'zh-CN': '按日柱估算',
      'zh-Hant': '按日柱估算',
      en: 'Estimate from day pillar',
    }),
    fillExactTime: pick(locale, {
      'zh-CN': '改填具体时间',
      'zh-Hant': '改填具體時間',
      en: 'Enter exact time',
    }),
    useCalendarPicker: pick(locale, {
      'zh-CN': '改用日历选择',
      'zh-Hant': '改用日曆選擇',
      en: 'Use calendar',
    }),
    useYmdDigits: pick(locale, {
      'zh-CN': '较早年份用数字填写',
      'zh-Hant': '較早年份用數字填寫',
      en: 'Type year / month / day',
    }),
    ymdYear: pick(locale, { 'zh-CN': '年 1984', 'zh-Hant': '年 1984', en: 'Year 1984' }),
    ymdMonth: pick(locale, { 'zh-CN': '月', en: 'Month' }),
    ymdDay: pick(locale, { 'zh-CN': '日', en: 'Day' }),
    noAccountNote: pick(locale, {
      'zh-CN': '不必先注册。直接生成人生 K 线、命理师判词与决策建议。',
      'zh-Hant': '不必先註冊。直接生成人生 K 線、命理師判詞與決策建議。',
      en: 'No account needed. Generate a Life K-Line, structural reading, and next moves.',
    }),
    seeSample: pick(locale, { 'zh-CN': '先看示例', 'zh-Hant': '先看示例', en: 'See a sample' }),
    streamLockNote: pick(locale, {
      'zh-CN': '先锁定命盘结构，再完善正文与行动清单——无需等待全部完成再离开。',
      'zh-Hant': '先鎖定命盤結構，再完善正文與行動清單——無需等待全部完成再離開。',
      en: 'Chart structure locks first, then the write-up and actions—you do not have to wait for every section.',
    }),
    streamSubmitting: pick(locale, {
      'zh-CN': '正在提交测算…',
      'zh-Hant': '正在提交測算…',
      en: 'Submitting chart…',
    }),
    streamAnalyzing: pick(locale, {
      'zh-CN': '分析进行中',
      'zh-Hant': '分析進行中',
      en: 'Analyzing',
    }),
    serviceUpdating: pick(locale, {
      'zh-CN': '服务刚在更新，请再点一次生成',
      'zh-Hant': '服務剛在更新，請再點一次生成',
      en: 'The service just updated. Tap generate once more.',
    }),
    existingReport: pick(locale, {
      'zh-CN': '已有报告？直接开场',
      'zh-Hant': '已有報告？直接開場',
      en: 'Already have a report? Open consulting',
    }),
    openOverview: pick(locale, {
      'zh-CN': '总览开场 →',
      'zh-Hant': '總覽開場 →',
      en: 'Overview opening →',
    }),
    ...
    quickExploreTitle: pick(locale, {
      'zh-CN': '填生日即可测',
      'zh-Hant': '填生日即可測',
      en: 'Birth date is enough',
    }),
    siteEntriesTitle: pick(locale, {
      'zh-CN': '站点入口',
      'zh-Hant': '站點入口',
      en: 'Site paths',
    }),
    commonToolsTitle: pick(locale, {
      'zh-CN': '常用工具',
      'zh-Hant': '常用工具',
      en: 'Common tools',
    }),
    openLink: pick(locale, { 'zh-CN': '打开', 'zh-Hant': '打開', en: 'Open' }),
    keepExploring: pick(locale, { 'zh-CN': '继续探索', 'zh-Hant': '繼續探索', en: 'Keep exploring' }),
    linkSpace: pick(locale, { 'zh-CN': '空间场', 'zh-Hant': '空間場', en: 'Space Lab' }),
    linkNaming: pick(locale, { 'zh-CN': '起名工坊', 'zh-Hant': '起名工坊', en: 'Naming' }),
    linkFace: pick(locale, { 'zh-CN': '面相', en: 'Face reading' }),
    linkPalm: pick(locale, { 'zh-CN': '手相', en: 'Palmistry' }),
    linkHehun: pick(locale, { 'zh-CN': '合婚双盘', 'zh-Hant': '合婚雙盤', en: 'Match charts' }),
    linkTeachers: pick(locale, { 'zh-CN': '请老师', 'zh-Hant': '請老師', en: 'Consultants' }),
    linkEvents: pick(locale, { 'zh-CN': '事件日历', 'zh-Hant': '事件日曆', en: 'Event calendar' }),
    linkCases: pick(locale, { 'zh-CN': '案例', en: 'Cases' }),
    linkProfile: pick(locale, { 'zh-CN': '资料', 'zh-Hant': '資料', en: 'Profile' }),
    statsEngines: pick(locale, { 'zh-CN': '引擎', en: 'Engines' }),
    statsKnowledge: pick(locale, { 'zh-CN': '知识', 'zh-Hant': '知識', en: 'Knowledge' }),
    statsCases: pick(locale, { 'zh-CN': '案例', en: 'Cases' }),
    fallbackTitle: pick(locale, {
      'zh-CN': '免费看清结构、阶段与下一步',
      'zh-Hant': '免費看清結構、階段與下一步',
      en: 'See structure, stage, and the next move — free',
    }),
