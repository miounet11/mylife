...
const MESSAGES: Record<string, { 'zh-CN': string; 'zh-Hant'?: string; en: string }> = {
  ...
  navWorkbench: { 'zh-CN': '测算', 'zh-Hant': '測算', en: 'Analyze' },
  navAnalyze: { 'zh-CN': '测算', 'zh-Hant': '測算', en: 'Analyze' },
  navDimensions: { 'zh-CN': '十维度', 'zh-Hant': '十維度', en: '10 Dimensions' },
  navTools: { 'zh-CN': '工具', 'zh-Hant': '工具', en: 'Tools' },
  navTeachers: { 'zh-CN': '请老师', 'zh-Hant': '請老師', en: 'Consultants' },
  navKnowledge: { 'zh-CN': '知识', 'zh-Hant': '知識', en: 'Knowledge' },
  ...
  navProfile: { 'zh-CN': '我的', 'zh-Hant': '我的', en: 'Profile' },
  navCases: { 'zh-CN': '案例', en: 'Cases' },
  navEvents: { 'zh-CN': '事件', en: 'Events' },
  navAnnual: { 'zh-CN': '年度复盘', 'zh-Hant': '年度複盤', en: 'Annual review' },
  navAlmanac: { 'zh-CN': '黄历', 'zh-Hant': '黃曆', en: 'Almanac' },
  navToday: { 'zh-CN': '今日', 'zh-Hant': '今日', en: 'Today' },
  ...
  navEngines: { 'zh-CN': '引擎', 'zh-Hant': '引擎', en: 'Engines' },
  footerHot: { 'zh-CN': '热门关注：', 'zh-Hant': '熱門關注：', en: 'Popular: ' },
  feedback: { 'zh-CN': '反馈', 'zh-Hant': '反饋', en: 'Feedback' },
  feedbackTitle: { 'zh-CN': '匿名报错 / 留言', 'zh-Hant': '匿名報錯 / 留言', en: 'Anonymous report / note' },
  feedbackHint: {
    'zh-CN': '无需登录。我们会在后台收集并定期修正（用神、身强弱、页面故障等）。',
    'zh-Hant': '無需登入。我們會在後台收集並定期修正（用神、身強弱、頁面故障等）。',
    en: 'No login needed. We collect notes in ops and fix useful-god, strength, and page bugs regularly.',
  },
  feedbackThanks: { 'zh-CN': '已收到，谢谢你的反馈', 'zh-Hant': '已收到，謝謝你的反饋', en: 'Received — thank you' },
  close: { 'zh-CN': '关闭', 'zh-Hant': '關閉', en: 'Close' },
  ...
  ctaStartShort: { 'zh-CN': '开始', 'zh-Hant': '開始', en: 'Start' },
...
export function buildEnglishPhraseMap(): Array<[string, string]> {
  ...
  const extras: Array<[string, string]> = [
    ...
    ['刚刚', 'just now'],
    ['命盘推演', 'Chart'],
    ['看清原局底色、岁运起伏与当下决断', 'See natal tone, decade rhythm, and the decision in front of you'],
    ['先定全局盘，再选一条具体方向', 'Lock the natal chart, then pick one concrete path'],
    ['直接生成我的报告', 'Generate my report'],
    ['进入分析', 'Open analysis'],
    ['限时免费会员', 'Limited free membership'],
    ['领取', 'Claim'],
    ['引擎可视化', 'Engine viz'],
    ['生成我的专属 K 线', 'Generate my K-Line'],
    ['真实引擎演算案例', 'Live engine samples'],
    ['直接回答', 'Direct answer'],
    ['如何使用', 'How to use'],
    ['常见问题', 'FAQ'],
    ['相关页面', 'Related'],
