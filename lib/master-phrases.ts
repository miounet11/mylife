...
export const MasterPhrases = {
  // 开头话术
  openings: [
    '细观您的八字，先看日主强弱与月令得失，再定扶抑用神。',
    '从您的八字来看，格局与十神已有主轴，下面按得令、得地、得势说明。',
    '细究您的命局：强弱定扶抑，调候作辅助，不宜空谈吉凶。',
    '观您之八字，宜先分清身旺身弱，再论用神喜忌与阶段节奏。',
    '从您的命盘来看，四柱结构清晰，以下按扶抑主线与岁运取舍。',
  ],

  // 描述话术（中性，避免一律「得令而旺」颠覆弱命用户认知）
  descriptions: [
    '宜先定日主强弱，再谈发挥方式',
    '格局已成形，重心在扶抑与阶段窗口',
    '五行有偏枯，取用在补缺与避耗',
