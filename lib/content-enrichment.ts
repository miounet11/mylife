...
export function buildFoundationKnowledgeArticles(): ContentArticle[] {
  const items: Array<{
    ...
    },
    {
      ...
      title: '用神与喜神（扶抑主线）',
      summary:
        '主用神按扶抑：身弱喜印比生扶，身旺喜克泄。喜神辅助主用；调候（冬火夏水）单独看，不与主用神混成「身弱却用火」。',
      angle: '用神',
      minutes: 8,
      faqs: [
        [
          '用神和调候有什么区别？',
          '用神是扶抑主线（平衡日主强弱）；调候是季节温度调节，作辅助，不替代主用神。',
        ],
        [
          '身弱为什么还提火？',
          '若出生在冬天，火是调候暖局，不是扶身主用。主用仍是水木一类印比。',
        ],
        ['用神会随流年变吗？', '结构主用神相对稳定，流年会改变侧重与窗口。'],
        ['多个用神如何取舍？', '优先 1–2 个主用神方向做成可核对的结果，再扩展喜神/调候。'],
      ],
      actions: ['记下本盘主用神（扶抑）与调候（如有）', '本周做一件与主用神同向的小事'],
    },
    {
