...
export const LEARNING_TRACKS: LearningTrack[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { key: 'city-hub', kind: 'knowledge', label: '城市主题总入口', href: '/world-yi/cities', readMinutes: 5 },
      { key: 'era-hub', kind: 'knowledge', label: '时代天时总入口', href: '/world-yi/era-timing', readMinutes: 6 },
      { key: 'era-three', kind: 'knowledge', label: '三层星象分析法', href: '/knowledge/world-yi-era-three-layer-stars', readMinutes: 9 },
      { key: 'era-four', kind: 'knowledge', label: '四象阶段论', href: '/knowledge/world-yi-era-four-phase', readMinutes: 8 },
      { key: 'era-uranus', kind: 'knowledge', label: '天王星周期与技术阶段', href: '/knowledge/world-yi-era-uranus-cycle', readMinutes: 10 },
      { key: 'city-insight', kind: 'insight', label: '城市观察：温哥华', href: '/insights/city/world-yi-city-vancouver', readMinutes: 6, slug: 'world-yi-city-vancouver' },
