...
export const GEO_CITY_SEEDS: Array<{
  ...
  {
    slug: 'world-yi-city-hangzhou',
    title: '城市观察：杭州',
    titleEn: 'City lens: Hangzhou',
    city: '杭州',
    cityEn: 'Hangzhou',
    region: '中国华东',
    regionEn: 'East China',
    summary: '数字经济与平台密度下的角色匹配、通勤成本与事业窗口。',
    summaryEn: 'Role fit, commute cost, and career windows under platform-economy density.',
    focus: ['事业', '数字经济', '居住'],
    focusEn: ['Career', 'Digital economy', 'Housing'],
  },
  {
    slug: 'world-yi-city-chengdu',
    title: '城市观察：成都',
    titleEn: 'City lens: Chengdu',
    city: '成都',
    cityEn: 'Chengdu',
    region: '中国西南',
    regionEn: 'Southwest China',
    summary: '生活节奏相对宽松，适合评估事业推进与家庭排序的再平衡。',
    summaryEn: 'Softer daily tempo — rebalance career push vs family priority.',
    focus: ['节奏', '家庭', '事业'],
    focusEn: ['Rhythm', 'Family', 'Career'],
  },
  {
    slug: 'world-yi-city-guangzhou',
    title: '城市观察：广州',
    titleEn: 'City lens: Guangzhou',
    city: '广州',
    cityEn: 'Guangzhou',
    region: '大湾区',
    regionEn: 'Greater Bay Area',
    summary: '商贸与供应链节点：现金流、人脉密度与跨境机会并存。',
    summaryEn: 'Trade and supply-chain node — cash flow, network density, cross-border options.',
    focus: ['财富', '商贸', '关系网络'],
    focusEn: ['Wealth', 'Trade', 'Networks'],
  },
  {
    slug: 'world-yi-city-wuhan',
    title: '城市观察：武汉',
    titleEn: 'City lens: Wuhan',
    city: '武汉',
    cityEn: 'Wuhan',
    region: '中国华中',
    regionEn: 'Central China',
    summary: '交通枢纽与教育科研密度：再出发窗口与家庭回流成本。',
    summaryEn: 'Transport hub + education density — restart windows vs family return costs.',
    focus: ['事业', '教育', '回流'],
    focusEn: ['Career', 'Education', 'Return'],
  },
  {
    slug: 'world-yi-city-xian',
    title: '城市观察：西安',
    titleEn: 'City lens: Xi’an',
    city: '西安',
    cityEn: 'Xi’an',
    region: '中国西北',
    regionEn: 'Northwest China',
    summary: '科研制造与历史文化叠层下的职业路径与生活成本结构。',
    summaryEn: 'Career paths and living costs under research-manufacturing + heritage layers.',
    focus: ['事业', '科研', '居住'],
    focusEn: ['Career', 'R&D', 'Housing'],
  },
  {
    slug: 'world-yi-city-dubai',
    title: '城市观察：迪拜',
    titleEn: 'City lens: Dubai',
    city: '迪拜',
    cityEn: 'Dubai',
    region: '中东',
    regionEn: 'Middle East',
    summary: '跨境税务、签证周期与高速商业节奏对结构的压力测试。',
    summaryEn: 'Visa cycles, tax structure, and high-speed commerce as a pressure test.',
    focus: ['迁移', '财富', '节奏'],
    focusEn: ['Migration', 'Wealth', 'Rhythm'],
  },
  {
    slug: 'world-yi-city-taipei',
    title: '城市观察：台北',
    titleEn: 'City lens: Taipei',
    city: '台北',
    cityEn: 'Taipei',
    region: '东亚',
    regionEn: 'East Asia',
    summary: '服务业与科技交织，生活密度高，适合评估角色与家庭排序。',
    summaryEn: 'Services meet tech in dense living — role fit vs family priority.',
    focus: ['事业', '家庭', '节奏'],
    focusEn: ['Career', 'Family', 'Rhythm'],
  },
];
