...
const AGENT_TASKS: Record<CoreAgentKey, { title: string; task: string; temperature: number }> = {
  core_constitution: {
    title: '核心命局专家',
    task: '解释命局底盘、优势、风险、性格主轴，禁止改写日主强弱和用忌神。',
    temperature: 0.45,
  },
  kline_narrative: {
    title: '人生K线专家',
    task: '围绕K线锚点、阶段、窗口解释高低起伏，任何年份判断必须与K线分数一致。',
    temperature: 0.55,
  },
  career_wealth: {
    title: '事业财富专家',
    task: '结合命局、K线和宏观周期，输出事业路径、财富方式和风控建议。',
    temperature: 0.55,
  },
  relationship_family: {
    title: '关系家庭专家',
    task: '聚焦婚恋、家庭、合作边界和关系修复，不得和关系窗口冲突。',
    temperature: 0.55,
  },
  health_lifestyle: {
    title: '健康生活方式专家',
    task: '聚焦体质、压力、作息和长期生活方式建议，不制造恐慌。',
    temperature: 0.45,
  },
  strategy_advisor: {
    title: '决策顾问',
    task: '把前面分析收束为未来1-3年的可执行动作和优先级。',
    temperature: 0.5,
  },
  temporal_spatial_advisor: {
    title: '天时地利人和顾问',
    task: '结合节气、立春、国运、行业运、地理气候和方位，回答什么时候、在哪里、顺着什么大势做什么。',
    temperature: 0.5,
  },
};
