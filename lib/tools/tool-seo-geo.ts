...
const PACKS: Record<string, ToolSeoGeoPack> = {
  ...
  physiognomy: {
    ...
    slug: 'physiognomy',
    name: '面相系统报告',
    title: '面相系统报告｜先物理结构再命理交叉｜人生K线',
    description:
      '上传面部照片：先读成像、三庭五眼与五官可见结构，再与生辰用神做气质/节奏教学交叉。系统报告含可信度、弱证据与可验证动作。非医学、非定命。',
    keywords: ['面相', '面相分析', '三庭五眼', '上传照片面相', '相学', '五官结构', '人生K线'],
    answerSummary:
      '面相系统报告固定先物理后命理：成像门槛 → 三庭五眼与五官分区 → 十二宫气质教学 → 生辰用神交叉 → 可验证动作。禁止疾病寿命与定命断语。照片默认私有。',
    searchIntents: ['上传照片看面相', '面相分析免费', '面相和八字一起看'],
    entityKeywords: ['面相', '三庭五眼', '五官', '十二宫', '生辰', '用神', '相学边界'],
    audienceQuestions: ['面相准吗？', '照片会不会公开？', '要不要填生日？'],
    audience: '想做系统性相学文化观察的用户',
    howTo: [
      { step: '上传照片', body: '正面、自然光、无浓妆滤镜。' },
      { step: '可选生辰', body: '勾选档案或填写出生日期，开启命理层。' },
      { step: '查看系统报告', body: '物理层 → 命理层 → 综合动作，含维度分与边界。' },
    ],
    faqs: [
      {
  ...
  palmistry: {
    ...
    slug: 'palmistry',
    name: '手相系统报告',
    title: '手相系统报告｜先物理掌纹再命理节奏｜人生K线',
    description:
      '上传手掌照片：先读手型与三主线可见形态，再交叉生辰谈行动节奏。系统报告含成像门槛、弱证据与 21 天复看。非医学、非定命。',
    keywords: ['手相', '掌纹', '手相分析', '生命线', '上传手相', '三主线'],
    answerSummary:
      '手相系统报告固定先物理后命理：成像 → 手型三线 → 掌丘气机教学 → 生辰用神节奏 → 可验证复盘。不编造吉凶定命。',
    searchIntents: ['上传手相照片分析', '掌纹生命线', '手相和八字'],
    entityKeywords: ['手相', '掌纹', '生命线', '智慧线', '感情线', '掌丘', '用神'],
    audienceQuestions: ['手相准吗？', '左右手看哪只？', '照片会泄露吗？'],
    audience: '想做系统性掌纹文化观察的用户',
    howTo: [
      { step: '上传手掌图', body: '手心向上、光线均匀、五指张开。' },
      { step: '选左右手', body: '可分别测，便于对照。' },
      { step: '可选生辰', body: '开启命理层用神节奏交叉。' },
    ],
    faqs: [
      {
        question: '会不会看寿命疾病？',
