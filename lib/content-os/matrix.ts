...
const LIFE_QUESTIONS: Array<{
  ...
  {
    slug: 'pick-home-or-shop',
    name: '怎么选房或选铺',
    topic: '户型、朝向、人流与人宅合参如何一起判断',
    uniqueAngle: '先结构场（光风滞留与人流密度），再叠同一套日主用神，不另起宅命',
    uniqueAngleEn: 'Structure field first (light, wind, stagnation, traffic), then the same natal useful-god — no second house chart',
    caseAngle: '两套南向三室怎么用滞留比和静区打分，而不是比哪套更吉',
    caseAngleEn: 'Score two south-facing 3-beds by stagnation and quiet zones, not lucky labels',
    keywords: ['选房子风水', '选铺面', '户型风水', '人宅合参'],
    cta: '/insights/space',
    intents: ['户型风水怎么看', '选铺面人流和风水', '人宅合参用神方位'],
  },
  {
    slug: 'study-major',
    name: '升学与专业方向',
...
const TOOLS = [
  ...
  { slug: 'fengshui', name: '空间场模拟', href: '/tools/fengshui-space', keywords: ['风水', '空间', '户型', '选铺', '人宅合参', '热力图'] },
