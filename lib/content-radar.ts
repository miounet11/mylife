...
const DEFAULT_CONTENT_RADAR_SOURCES: ContentRadarSource[] = [
  ...
  {
    id: 'google-news-psychology',
    label: 'Google News · Psychology',
    platform: 'google-news',
    url: 'https://news.google.com/rss/search?q=psychology+when:7d&hl=en-US&gl=US&ceid=US:en',
    type: 'rss',
    enabled: true,
    keywords: ['psychology', 'emotion', 'stress', 'relationship'],
  },
  {
    id: 'google-news-philosophy',
    label: 'Google News · Philosophy',
    platform: 'google-news',
    url: 'https://news.google.com/rss/search?q=philosophy+when:7d&hl=en-US&gl=US&ceid=US:en',
    type: 'rss',
    enabled: true,
    keywords: ['philosophy', 'ethics', 'metaphysics', 'epistemology'],
  },
  {
    id: 'google-news-history',
    label: 'Google News · History',
    platform: 'google-news',
    url: 'https://news.google.com/rss/search?q=history+when:7d&hl=en-US&gl=US&ceid=US:en',
    type: 'rss',
    enabled: true,
    keywords: ['history', 'timeline', 'historian', 'archive'],
  },
  {
    id: 'google-news-ai',
    ...
    type: 'rss',
    enabled: true,
    keywords: ['ai', 'agent', 'llm', 'machine learning'],
  },
  {
    id: 'google-news-statistics',
    label: 'Google News · Statistics',
    platform: 'google-news',
    url: 'https://news.google.com/rss/search?q=statistics+when:7d&hl=en-US&gl=US&ceid=US:en',
    type: 'rss',
    enabled: true,
    keywords: ['statistics', 'probability', 'data', 'causal'],
  },
  {
    id: 'google-news-programming',
    label: 'Google News · Programming',
    platform: 'google-news',
    url: 'https://news.google.com/rss/search?q=programming+when:7d&hl=en-US&gl=US&ceid=US:en',
    type: 'rss',
    enabled: true,
    keywords: ['programming', 'software', 'developer', 'automation'],
  },
  {
