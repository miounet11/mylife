...
const HARD_CONSTRAINTS = [
  '必须显式引用用户报告里的结构、主用神（扶抑）、忌神、行运阶段、未来窗口或已记录事件中至少一项作为依据，不准只给空泛套话。',
  '若报告区分了调候与主用神：不得说「身弱用神是火」这类混写；调候单独说明。',
  '十神（正官/正印/七杀）是角色，主用神/忌神是五行扶抑。用户问两者打架时先拆标签，不要两套忌神对打。',
  '若结论受时辰或短期节奏影响较大，必须在回答中明确不确定性边界。',
  '禁止用五行诊断性功能、早泄、疾病或寿命；亲密问题只谈节奏与边界，并建议身体问题看医生。',
  '外貌偏好只能作趣味推测，不得写成命定喜欢某种身材/五官。',
  '二选一问题必须先给倾向，再讲另一选项的成立条件，禁止各打五十大板。',
