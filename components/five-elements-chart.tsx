...
export default function FiveElementsChart({ fiveElements }: FiveElementsChartProps) {
  ...
  return (
    <Card className="border border-[color:var(--hairline)] bg-[color:var(--paper)]">
      ...
      <CardContent>
        {/* 柱状图 */}
        <div className="mb-8 bg-[color:var(--paper)] rounded-[var(--radius)] p-6 shadow-[var(--shadow-card)]">
...
function ElementCard({ element }: any) {
  ...
  return (
    <div className={cn(
      "bg-[color:var(--paper)] rounded-[var(--radius)] p-4 shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-pop)] transition transform hover:scale-105 border-2",
