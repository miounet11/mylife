        ...
        >
          {isEditing ? (
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 text-[11px]">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    className="inline-flex items-center gap-1 rounded-[3px] border border-white/40 bg-white/10 px-2 py-1 text-[11px] font-semibold text-white"
                  >
                    <X className="h-3 w-3" />
                    取消
                  </button>
                  <button
                    ...
                    disabled={isActing}
                    className="inline-flex items-center gap-1 rounded-[3px] bg-white px-2 py-1 text-[11px] font-bold text-[#3b5998] disabled:cursor-not-allowed disabled:opacity-60"
                  >
            ...
            <>
                ...
                <div className="mt-2 rounded-[4px] border border-white/25 bg-white/10 px-2 py-1.5 text-[12px] leading-5">
                  ...
                  <div className="mt-1 flex flex-wrap gap-1">
                    {message.materials.map((material) => (
                      <span
                        key={material.id}
                        className="rounded-[3px] border border-white/30 bg-white/10 px-1.5 py-0.5 text-[11px] font-semibold"
                      >
              ...
              <div className="mt-1.5 flex flex-wrap items-center justify-end gap-1.5 text-[11px] text-white/80">
                <span>{time}</span>
                {message.edited ? (
  ...
  return (
    <div className="flex justify-start">
      ...
      >
        ...
        <div className="mt-2 flex flex-wrap items-center justify-between gap-2 text-[11px] text-[#606770]">
          <span>
            {message.llmUsed
              ? '结合当前报告与对话内容生成'
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            <button
              ...
              disabled={isActing}
              className="fb-btn inline-flex items-center gap-1 px-2 py-1 text-[11px] font-semibold text-[#1d2129] disabled:cursor-not-allowed disabled:opacity-60"
            >
            ...
            <button
              ...
              className="fb-btn inline-flex items-center gap-1 px-2 py-1 text-[11px] font-semibold text-[#1d2129]"
            >
